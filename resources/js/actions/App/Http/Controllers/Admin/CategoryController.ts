...
* @see app/Http/Controllers/Admin/CategoryController.php:17
...
* @see app/Http/Controllers/Admin/CategoryController.php:84
...
* @see app/Http/Controllers/Admin/CategoryController.php:103
* @route '/dashboard/categories/{category}'
*/
