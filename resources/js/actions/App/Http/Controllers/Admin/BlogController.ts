...
* @see app/Http/Controllers/Admin/BlogController.php:43
...
* @see app/Http/Controllers/Admin/BlogController.php:86
...
* @see app/Http/Controllers/Admin/BlogController.php:99
...
* @see app/Http/Controllers/Admin/BlogController.php:153
* @route '/dashboard/blogs/{blog}'
*/
...
const BlogController = { index, create, store, edit, update, destroy }
