...
* @see app/Http/Controllers/Frontend/VisaBulletin.php:211
* @route '/visa-bulletin'
*/
...
* @see app/Http/Controllers/Frontend/VisaBulletin.php:228
...
* @see app/Http/Controllers/Frontend/VisaBulletin.php:253
...
* @see app/Http/Controllers/Frontend/VisaBulletin.php:87
...
* @see app/Http/Controllers/Frontend/VisaBulletin.php:133
...
* @see app/Http/Controllers/Frontend/VisaBulletin.php:166
...
* @see app/Http/Controllers/Frontend/VisaBulletin.php:35
* @route '/about'
*/
...
const VisaBulletin = { index, VisaBulletinDetail, RecentApprovals, contactus, contactStore, sendOtp, verifyOtp, sendOtpSlider, verifyOtpSlider, cspaAgeCalculator, about, blog }
