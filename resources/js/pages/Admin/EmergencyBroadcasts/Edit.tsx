...
export default function Edit({ emergencyBroadcast }: Props) {
    const {
        data,
        setData,
        put,
        ...
        description: emergencyBroadcast.description,
    ...
    const submit = (e: FormEvent) => {
        ...
        put(`/dashboard/emergency-broadcasts/${emergencyBroadcast.id}`);
    };
